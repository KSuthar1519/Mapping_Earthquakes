...
//We create the third tile layer that is the dark map.
...
//this will determine the color for the pointer/circle based on the magnitude
function getColor(magnitude) {
  if (magnitude > 5) {
    return "#ea2c2c";
  }
...
//Then we add the major Earthquakes layer to the map
